...
<p class="mb-3 text-xs uppercase tracking-[0.2em] text-white/70">Navigation</p>
...
<li><a class="block rounded px-3 py-2 text-white hover:bg-white/10" href={resolve('/documentation')}>Documentation</a></li>
<!-- <li>
