...
export function createNavigatorRouter(service: NavigatorService) {
  ...
  router.get("/approvals/:approvalRequestId", async (req, res, next) => {
    try {
      const result = await service.approval(req.params.approvalRequestId);
      res.json(result);
    } catch (error) {
      next(error);
    }
  ...
  router.post("/approvals/:approvalRequestId/approve", async (req, res, next) => {
    try {
      const body = approvalResolutionSchema.parse(req.body ?? {});
      const result = await service.approveApprovalRequest(req.params.approvalRequestId, body);
      res.json(result);
    } catch (error) {
      next(error);
    }
  ...
  router.post("/approvals/:approvalRequestId/reject", async (req, res, next) => {
    try {
      const body = approvalResolutionSchema.parse(req.body ?? {});
      const result = await service.rejectApprovalRequest(req.params.approvalRequestId, body);
      res.json(result);
    } catch (error) {
      next(error);
    }
  ...
  router.post("/approvals/:approvalRequestId/escalate", async (req, res, next) => {
    try {
      const body = approvalResolutionSchema.parse(req.body ?? {});
      const result = await service.escalateApprovalRequest(req.params.approvalRequestId, body);
      res.json(result);
    } catch (error) {
      next(error);
    }
