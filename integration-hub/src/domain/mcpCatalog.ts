...
const FUNCTION_DEFS = [
  ...
  { id: "p2p_approve_requisition", entity: "Requisition", domain: "p2p", aggregateType: "requisition", action: "approve_requisition", operationType: "transition", description: "Transition requisition to Approved", riskLevel: "Medium", governanceTag: "P2P.Requisition.Approve" },
  { id: "p2p_convert_requisition_to_po", entity: "Requisition", domain: "p2p", aggregateType: "requisition", action: "convert_requisition_to_po", operationType: "transition", description: "Convert requisition to PO", riskLevel: "Medium", governanceTag: "P2P.Requisition.Convert" },
  ...
  { id: "o2c_send_quote", entity: "Quote", domain: "o2c", aggregateType: "quote", action: "send_quote", operationType: "transition", description: "Send quote", riskLevel: "Low", governanceTag: "O2C.Quote.Send" },
  { id: "o2c_accept_quote", entity: "Quote", domain: "o2c", aggregateType: "quote", action: "accept_quote", operationType: "transition", description: "Accept quote", riskLevel: "Low", governanceTag: "O2C.Quote.Accept" },
  { id: "o2c_convert_quote_to_order", entity: "Quote", domain: "o2c", aggregateType: "quote", action: "convert_quote_to_order", operationType: "transition", description: "Convert quote to order", riskLevel: "Medium", governanceTag: "O2C.Quote.Convert" },
  { id: "o2c_confirm_order", entity: "SalesOrder", domain: "o2c", aggregateType: "sales-order", action: "confirm_order", operationType: "transition", description: "Confirm order", riskLevel: "Medium", governanceTag: "O2C.Order.Confirm" },
  { id: "o2c_allocate_stock", entity: "SalesOrder", domain: "o2c", aggregateType: "sales-order", action: "allocate_stock", operationType: "transition", description: "Allocate stock", riskLevel: "Medium", governanceTag: "O2C.Order.Allocate" },
  { id: "o2c_ship_order", entity: "SalesOrder", domain: "o2c", aggregateType: "sales-order", action: "ship_order", operationType: "transition", description: "Ship order", riskLevel: "Medium", governanceTag: "O2C.Order.Ship" },
