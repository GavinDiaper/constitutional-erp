...
Mesh Gateway is the constitutional enforcement point between clients and Foundation ERP.
...
- Readiness gating: `/mesh/ready` returns 503 until Authority, Governance, and Foundation ERP are ready.
