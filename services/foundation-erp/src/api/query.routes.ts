...
const tablePrimaryKeys = {
  ...
  // ERP Mapping v2 — normalised tables
  erp_system: "system_id",
  erp_canonical_entity: "entity_id",
  erp_canonical_field: "field_id",
  erp_field_mapping: "id",
  erp_process: "process_id",
  erp_process_step: "step_id",
  erp_process_system_mapping: "id",
  erp_system_field: "id",
  // ERP Mapping v2 — comparison views
  v_cross_system_field_compare: "field_id",
  v_system_gap_report: "domain",
  v_process_coverage: "process_id",
  v_gap_fields_by_system: "field_id",
  v_system_specific_fields: "id",
  migration: "id",
