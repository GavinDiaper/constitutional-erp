...
<section class="glass-panel p-6">
	...
	{#if lastResult}
		<div class="mt-4 rounded-md border border-emerald-500/45 bg-emerald-500/10 p-4 text-sm">
			...
			<div class="mt-3 flex flex-wrap gap-2">
				{#if lastResult.entityType && lastResult.entityId}
					<a class="rounded-md border dark:border-white/35 border-slate-300 px-3 py-2 text-xs dark:text-white text-slate-900" href={resolve(`/canvas/${lastResult.entityType}/${lastResult.entityId}`)}>
						Open Process
					</a>
				{/if}
				<a class="rounded-md border dark:border-white/35 border-slate-300 px-3 py-2 text-xs dark:text-white text-slate-900" href={resolve('/dashboard')}>
					Back to Dashboard
				</a>
			</div>
		</div>
	...
	{#if activeTab === 'O2C'}
		<div class="mt-5 grid gap-3 xl:grid-cols-2">
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4 xl:col-span-2">
				...
				<div class="mt-3 flex flex-wrap gap-2">
					<a class="rounded-md border dark:border-white/35 border-slate-300 px-3 py-2 text-xs dark:text-white text-slate-900" href={resolve('/canvas/o2c/orders/open')}>
						Open Orders ({orders.length})
					</a>
					<a class="rounded-md border dark:border-white/35 border-slate-300 px-3 py-2 text-xs dark:text-white text-slate-900" href={resolve('/canvas/o2c/invoices/open')}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Company name" bind:value={customerForm.customerName} />
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Email" bind:value={customerForm.email} />
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Billing address" bind:value={customerForm.billingAddress} />
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Shipping address" bind:value={customerForm.shippingAddress} />
				</div>
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null} on:click={() => runOperation('create-customer', customerForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<div class="grid grid-cols-3 gap-2">
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="SKU (optional)" bind:value={quoteForm.lineSku} />
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="number" min="1" step="1" placeholder="Qty" bind:value={quoteForm.lineQuantity} />
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="number" min="0" step="0.01" placeholder="Unit price" bind:value={quoteForm.lineUnitPrice} />
					</div>
					<select class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" bind:value={quoteForm.lineTaxTreatment}>
				...
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || !quoteForm.legalEntityId} on:click={() => runOperation('create-quote', quoteForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="number" min="0.01" step="0.01" placeholder="Amount" bind:value={paymentForm.amount} />
					<div class="grid grid-cols-2 gap-2">
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Currency (USD)" bind:value={paymentForm.currencyCode} />
					...
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="date" bind:value={paymentForm.paymentDate} />
				</div>
				{#if invoices.length === 0}
					<p class="muted mt-2 text-xs">No invoices found. Create and post an invoice before registering payment.</p>
				{/if}
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || invoices.length === 0 || !paymentForm.invoiceId} on:click={() => runOperation('create-payment', paymentForm)}>
		...
		<div class="mt-5 grid gap-3 xl:grid-cols-2">
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<div class="grid grid-cols-2 gap-2">
						...
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Tax ID" bind:value={supplierForm.taxId} />
					</div>
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Currency (USD)" bind:value={supplierForm.currencyCode} />
				</div>
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null} on:click={() => runOperation('create-supplier', supplierForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<div class="grid grid-cols-2 gap-2">
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Currency (USD)" bind:value={requisitionForm.currencyCode} />
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="date" bind:value={requisitionForm.neededByDate} />
					</div>
				</div>
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || !requisitionForm.legalEntityId} on:click={() => runOperation('create-requisition', requisitionForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<div class="grid grid-cols-2 gap-2">
						...
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Currency (USD)" bind:value={purchaseOrderForm.currencyCode} />
					</div>
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Delivery address" bind:value={purchaseOrderForm.deliveryAddress} />
				</div>
				{#if suppliers.length === 0}
					<p class="muted mt-2 text-xs">No suppliers found. Create a supplier first.</p>
				{/if}
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || suppliers.length === 0 || !purchaseOrderForm.supplierId} on:click={() => runOperation('create-purchase-order', purchaseOrderForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				{/if}
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || purchaseOrders.length === 0 || !goodsReceiptForm.poId} on:click={() => runOperation('create-goods-receipt', goodsReceiptForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<div class="grid grid-cols-2 gap-2">
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="date" placeholder="Invoice date" bind:value={supplierInvoiceForm.invoiceDate} />
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="date" placeholder="Due date" bind:value={supplierInvoiceForm.dueDate} />
					</div>
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Currency (USD)" bind:value={supplierInvoiceForm.currencyCode} />
				</div>
				{#if goodsReceipts.length === 0}
					<p class="muted mt-2 text-xs">No goods receipts found. Create a goods receipt first.</p>
				{/if}
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || goodsReceipts.length === 0 || !supplierInvoiceForm.receiptId} on:click={() => runOperation('create-supplier-invoice', supplierInvoiceForm)}>
			...
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="number" min="0.01" step="0.01" placeholder="Amount" bind:value={apPaymentForm.amount} />
					<div class="grid grid-cols-2 gap-2">
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Currency (USD)" bind:value={apPaymentForm.currencyCode} />
						<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Method" bind:value={apPaymentForm.method} />
					</div>
				</div>
				{#if supplierInvoices.length === 0}
					<p class="muted mt-2 text-xs">No supplier invoices found. Create a supplier invoice first.</p>
				{/if}
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null || supplierInvoices.length === 0 || !apPaymentForm.supplierInvoiceId} on:click={() => runOperation('create-ap-payment', apPaymentForm)}>
		...
		<div class="mt-5 grid gap-3 xl:grid-cols-2">
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					...
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" type="number" min="0" step="0.01" placeholder="Amount" bind:value={journalForm.amount} />
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Line memo" bind:value={journalForm.memo} />
				</div>
	...
	{#if activeTab === 'H2R'}
		<div class="mt-5 grid gap-3 xl:grid-cols-2">
			<div class="rounded-lg border dark:border-white/15 border-slate-200 dark:bg-white/5 bg-slate-100/60 p-4">
				...
				<div class="mt-3 grid gap-2">
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Employee full name" bind:value={employeeForm.name} />
					<input class="rounded-md border dark:border-white/25 border-slate-300 bg-[var(--input-bg)] px-3 py-2 text-sm" placeholder="Employee email" bind:value={employeeForm.email} />
				...
				<button class="mt-3 rounded-md dark:bg-white dark:text-slate-900 bg-slate-900 text-white px-3 py-2 text-sm font-semibold text-slate-900 disabled:opacity-60" disabled={runningKey !== null} on:click={() => runOperation('create-employee', employeeForm)}>
