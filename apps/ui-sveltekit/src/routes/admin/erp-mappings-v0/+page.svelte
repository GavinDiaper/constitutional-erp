...
<section class="space-y-4">
	<div>
		<h2 class="text-2xl font-semibold">ERP Mappings <span class="ml-2 rounded border dark:border-white/25 border-slate-300 px-2 py-0.5 text-sm font-normal dark:text-white/60 text-slate-500">V0 — Legacy</span></h2>
		<p class="muted mt-2 text-sm">Legacy view of <span class="font-semibold">erp_mapping</span> (flat 3-system table). See <a class="underline" href={resolve('/admin/erp-mappings')}>ERP Mappings</a> for the current multi-system view.</p>
	</div>
